            ...
            <div class="card-body">
                <div class="row align-items-center no-gutters">
                    <div class="col me-2">
                        ...
                        <div class="text-dark fw-bold h5 mb-0"><span><?php echo money_format($todayRevenue) ;?></span></div>
                    </div>
            ...
            <div class="card-body">
                <div class="row align-items-center no-gutters">
                    <div class="col me-2">
                        ...
                        <div class="text-dark fw-bold h5 mb-0"><span><?php echo money_format($monthlyRevenue) ;?></span></div>
                    </div>
                    <div class="col-auto"><i class="fas fa-dollar-sign fa-2x text-gray-300"></i></div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row align-items-center no-gutters">
                    <div class="col me-2">
                        ...
                        <div class="text-dark fw-bold h5 mb-0"><span><?php echo money_format($yearlyRevenue) ;?></span></div>
                    </div>
                    <div class="col-auto"><i class="fas fa-dollar-sign fa-2x text-gray-300"></i></div>
                </div>
            </div>
                    ...
                    <tbody>
                        <?php foreach ($top5MostSoldProducts as $product) { ?>
                            <tr>
                                ...
                                <td><?php echo money_format($product->getTotalSold() * $product->getPrice()); ?></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
